            ...
            <section className="max-w-4xl p-6 mx-auto bg-indigo-600  shadow-md dark:bg-black mt-2">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-start mt-6">
                        <button
                            className="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-red-600 rounded-md hover:bg-red-600 focus:outline-none focus:bg-gray-600"
